        ...
        <div class="space-y-1.5 bg-gray-900 dark:bg-gray-800 p-6 flex flex-col items-center gap-4">
          <span class="relative flex shrink-0 overflow-hidden rounded-full w-20 h-20">
            <img
              ...
              alt="Pawan"
              src="https://i.imgur.com/L52SDtD.jpg"
            />
          </span>
          <div class="text-center">
            <h3 class="text-xl font-bold text-white">Pawan Gupta</h3>
        ...
        <div class="p-6 grid gap-4">
          <div class="prose prose-invert prose-sm">
            <p class="text-black">
              ...
              building modern, responsive web applications. I am specialized in
              JavaScript, React, Nextjs,Nodejs,Expressjs and MongoDB also
          ...
          <div class="flex justify-center gap-4">
            ...
            <a
              href="https://www.linkedin.com/in/pawangupta01/"
