        ...
        <div className=" flex flex-col my-5 gap-5">
          <div className="flex flex-col my-5 p-5 rounded-lg border border-gray-400 gap-5">
            <h2 className="text-xl  font-medium">
              <strong className="text-pink-900">Job Role/Job Position: </strong>
            ...
            <h2 className="text-xl font-medium">
              <strong className="text-pink-900">Years of Experience: </strong>
              {interviewData?.jobExperience}
            </h2>
          </div>

          <div className="p-5 border-2 rounded-lg border-slate-900 bg-slate-300">
            <h2 className="flex gap-2 items-center text-slate-900">
              <Lightbulb />
